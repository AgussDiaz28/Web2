	...
	/* ALTERS en TIPO_PAGO */
	ALTER TABLE gr10_tipo_pago ALTER COLUMN empresa TYPE VARCHAR(25);
	...
	/* inserts de reserva */
	insert into gr10_reserva values (1,now(),'2018-09-01','2019-01-24','TIPO',4,1600,1,1,38524932);
	insert into gr10_reserva values (2,now(),'2018-06-26','2018-07-14','TIPO',1,800,1,2,42908673);
	insert into gr10_reserva values (3,now(),'2018-06-27','2018-07-10','TIPO',2,600,1,3,13244453);
	insert into gr10_reserva values (4,now(),'2018-06-27','2018-08-14','TIPO',2,500,1,1,27890165);
	insert into gr10_reserva values (5,now(),'2018-07-01','2018-08-30','TIPO',1,450,1,1,25908361);
	...
	insert into gr10_comentario values (1,25908361,5,now(),'Preferentemente quiero la habitacion negra en un piso alto de ser posible',5);
	insert into gr10_comentario values (3,13244453,3,now(),'Preferentemente quiero la habitacion blanca en un piso alto de ser posible',5);
	insert into gr10_comentario values (2,42908673,2,now(),'Preferentemente quiero la habitacion en un piso mediano de ser posible',5);
	insert into gr10_comentario values (1,27890165,4,now(),'Preferentemente quiero la habitacion en un piso bajo de ser posible',5);
	...
	*/
	...
	insert into gr10_pago values (now(),4,4,3,100);
	insert into gr10_pago values (now(),5,5,3,100);
